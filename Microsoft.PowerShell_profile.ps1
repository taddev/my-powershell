# Description: My user profile information for powershell
#
# Author: Tad DeVries
...
##Change to the H drive incase we're not already there
#h:

##Change to Documents Folder because that's where my stuff is
#cd Documents

New-PSDrive -name Scripts -psprovider FileSystem -root "c:\Users\tadd\SkyDrive\Work Docs\WindowsPowerShell" -Description "Scripts Folder"
New-PSDrive -name Docs -psprovider FileSystem -root "c:\Users\tadd\SkyDrive\Work Docs" -Description "My Documents"
. Scripts:\Profiles\profile.ps1

# SIG # Begin signature block
# MIIbaQYJKoZIhvcNAQcCoIIbWjCCG1YCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUUoAg/ULWf49LfgoJtycZPryX
# vAGgghYbMIIDnzCCAoegAwIBAgIQeaKlhfnRFUIT2bg+9raN7TANBgkqhkiG9w0B
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRWPS3739MNE9ajmEfv
# KTWYZcMQmzANBgkqhkiG9w0BAQEFAASCAgA7H9ZuTo4Ir47f8XWagxZ2TXMuY235
# +k2nLuk2h01gE6Ub+ue2x29/CQ0Jm0umMAjf+nmB15KszSe726wOQ4cLT0Bp3k2W
# YgAwnGfWUkNu68+AY09wqDKIkWVp+8dk5OxOxgI0kU4fIIZW5ZUDvDWrAbizBHCg
# g92NYvImlMzYbMJurr8veQIUTCLmOgh/TwG0SAFKmLODE/l+dWgjdc+SGJ97cilJ
# /2Dme5ZcqTegF4aNJRDQKG49qbNiIMHGbyBxHpg7eDISKCbOA2/MSioK36XGJK0C
# HjJnyX9JKgSRA4hx2DgYJ4/0PF+/JCLFVyVdUXrUSJv4As1twry2V0ZxxZpV6Yvo
# wadY5CZ5OB+50ju6Y3szoTAerzYI5bZuwxECiY1yR3Kp3SpmeiX9ntm7QVUa5SCE
# 9wKvAYPgd6mGhyrisDwlqnI1Mj3ONIhG8il0/i+2+Ji4owvMlCZ8/NkTjvi3roTy
# Q2Z8GAQ9gQhmifUANFsoTUPyIo0wayuAkhwqOtDmXw62pI6YmS37hxYTQPaevqmw
# tngP1B/sR0VghSEew/C8BuyLe57QRBXEOvbZF8UhNVN40BHedLlxDhtEAGnL79PU
# GcNlTCDGNuTkhio0UWKRSk+GRYbGLHh+XucHdIWmob/y1Pqp6ZKyQh0DQsIjPh2N
# SbFdZNTBCqaPT6GCAX8wggF7BgkqhkiG9w0BCQYxggFsMIIBaAIBATBnMFMxCzAJ
...
# 9w0BCQUxDxcNMTIxMDI3MDI0NDQ3WjAjBgkqhkiG9w0BCQQxFgQUONCTJxoEQfCQ
# Q27xY2xS8S12RS4wDQYJKoZIhvcNAQEBBQAEgYCJOzmJZCGSn7hhl/5zf2m7z0mD
# Ea2uSOtPqfbV/37GGBkCN9f5szsbxWb+HV4kb/em9TGbjAdEaaJNKD3C0zv9SmNs
# wUW/aeobd4tAyiP5hA16Em38SY2V1X5xCBexz9Q2H5D2/FXX0WdC41H1KIBEIwAy
# oSqPjEr3p804R2QgIw==
